              ...
              <li v-for="course in courseList" :key="course.id">
                <div class="cc-l-wrap">
                  <section class="course-img">
                    ...
                    <div class="cc-mask">
                      <!-- <a href="/course/index" title="开始学习" target="_blank" class="comm-btn c-btn-1">开始学习</a> -->
                      <a :href="'/course/'+course.id" title="开始学习" target="_blank" class="comm-btn c-btn-1">开始学习</a>
                    </div>
                  </section>
                  <h3 class="hLh30 txtOf mt10">
                     <!-- <a :href="'/course/_id/'+course.id" title="开始学习" target="_blank" class="comm-btn c-btn-1">开始学习</a> -->
