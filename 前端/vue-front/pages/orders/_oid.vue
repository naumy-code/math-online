    ...
    <form name="flowForm" id="flowForm" method="post" action="">
      ...
      <div class="Finish">
        <div class="fr" id="AgreeDiv">
          ...
          <label for="Agree"><p class="on"><input type="checkbox" checked="checked">我已阅读并同意<a href="javascript:" target="_blank">《小学数学线上教育购买协议》</a></p></label>
        </div>
        <div class="clear"></div>
        <div class="Main fl">
          <div class="fl">
...
export default {
    ...
    methods:{
        //去支付
        toPay() {
        ordersApi.Alipay(this.order.orderNo)
        .then(response => {
            document.querySelector('body').innerHTML = response;
            const div = document.createElement('div');
            div.innerHTML = response.data.data.pay;
